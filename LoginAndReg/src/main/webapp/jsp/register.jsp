...
<form:form name="regForm" id="regForm" modelAttribute="user" action="registerProcess" method="post" onsubmit="return validateform()">
 ...
 <table align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <form:input path="username" name="username" id="username" /><div><span style="color: red;">${uexists}</span> </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                       ...
                       <!-- <td><form:checkbox path="password" onclick="myFunction()" value="${user.password} unchecked"/> Show Password</td>-->
                    </tr>
                    <tr>
                        <td>
